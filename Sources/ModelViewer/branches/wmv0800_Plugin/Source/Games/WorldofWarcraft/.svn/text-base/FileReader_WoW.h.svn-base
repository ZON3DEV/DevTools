/*
	...
	Header file for reading WoW file formats into the Model Viewer Model format.
*/

#ifndef WORLDOFWARCRAFT_FILEREADER_H
#define WORLDOFWARCRAFT_FILEREADER_H
	
/*
An important list of WoW-Specific model properties, this list specifies details
we'll need to be able to access and put into the ModelViewerModel format.

NOTE: This list was originally designed for exporters. Some listed functionalities will be handled by WMV before the data is sent to the exporters.
